...
A math-equation-driven animation spec for explainer videos. Everything is a parametric function of time. The spec is designed to be AI-generatable, declarative (data, not code), and renderer-agnostic.
